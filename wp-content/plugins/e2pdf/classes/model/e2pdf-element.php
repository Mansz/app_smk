...
class Model_E2pdf_Element extends Model_E2pdf_Model {
    ...
    public function load($element_id, $template_id, $revision_id = 0) {
        ...
        if ($element) {
            ...
            $this->set('properties', unserialize($element['properties'], array('allowed_classes' => false)));
            $this->set('actions', unserialize($element['actions'], array('allowed_classes' => false)));
            return true;
        }
        return false;
    }
