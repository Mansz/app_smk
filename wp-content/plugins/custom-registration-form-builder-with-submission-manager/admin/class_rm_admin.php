   ...
   version="1.1"><metadata
                            ...
                            if ($value[0] == 'rm_form_manage') {
                                ...
                                */
                                ...
                                if (current_user_can( "manage_options" )){
                                    ...
                                    add_submenu_page("rm_dummy_string", RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), $value[0]."manage_options", "rm_options_admin_menu", array($this->get_controller(), 'run'));
    ...
    public function admin_upsell_notices()
    {
        ...
        if(defined('REGMAGIC_ADDON') && $this->get_license_status()=='inactive' && isset($_GET['page']) && $_GET['page'] == 'rm_licensing') { 
            ...
            <div class="rm_admin_notice_banner rm-notice-banner notice notice-error inline notice-alt rm-py-2 rm-my-2">
